...
folder = '/mnt/data_drive/projects/UCD01 - Privacy preserving data collection/data/batch3/raw/20230115/'
file_sensorlogger = f'{folder}/i7/sensorlogger/2023-01-15_12-49-45/Accelerometer.csv'
file_watch = f'{folder}/h2c4/watch/1673786987477_Nanh2_Badmintonserving_5.csv'
